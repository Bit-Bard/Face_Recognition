...
def get_cv2_image_from_base64_string(b64str):
    try:
        ...
        if ',' in b64str:
            b64str = b64str.split(',')[1]  # Remove metadata if present
...
HAARCASCADE_PATH = r"c:\Users\dhruv\OneDrive\Desktop\Face_Recognition\server\artifacts\opencv\haarcascades"
...
def load_saved_artifacts():
    ...
    #C:\Users\dhruv\OneDrive\Desktop\Face_Recognition\server\artifacts  ./artifacts/class_dictionary.json C:\Users\dhruv\OneDrive\Desktop\Face_Recognition\server\artifacts   ./artifacts/saved_model.pkl./server/artifacts/class_dictionary.json
...
def get_b64_test_image_for_virat():
    with open("./server/artifacts/base64.txt") as f:
        return f.read()
#C:\Users\dhruv\OneDrive\Desktop\Face_Recognition\server\artifacts
